...
- **이번 판(r42) 변경 — 행동 기록 수집이 켜집니다.** 판 요약 기록(기존)에 더해 «어떤 화면에서 무엇을 눌렀는가»를 순서대로 남깁니다(판당 10KB 안팎). 개인 식별 정보는 여전히 하나도 수집하지 않습니다. 자세한 내용과 끄는 방법은 함께 드리는 `수집항목-설명.md` 3-2절에 있습니다. **학교·교육청에 안내가 필요하면 이 문서를 그대로 쓰시면 됩니다.**
