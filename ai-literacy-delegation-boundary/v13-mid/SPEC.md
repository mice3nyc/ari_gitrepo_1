...
- **변경**: `CONFIG.rpRewardByGrade` {S:5, A:3, B:2, C:1, D:0} → **{S:30, A:20, B:15, C:10, D:0}** / `CONFIG.rpLevelUpBonusByLevel` {2:3, 3:4, 4:5, 5:6} → **{2:10, 3:15, 4:20, 5:25}**.
...
- **D:0 유지**: D 등급 무보상은 기존 설계 그대로 — 변경 원하면 피터공 결정.
