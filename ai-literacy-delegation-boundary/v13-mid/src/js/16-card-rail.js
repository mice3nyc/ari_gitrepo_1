...
function _abilityCardCount(){var inv=gameState&&gameState.inventory;return (inv&&inv.domainCards)?inv.domainCards.length:0;}
function _delegationCardCount(){var inv=gameState&&gameState.inventory;if(!inv)return 0;return (inv.humanCentricCards?inv.humanCentricCards.length:0)+(inv.growthCards?inv.growthCards.length:0);}
