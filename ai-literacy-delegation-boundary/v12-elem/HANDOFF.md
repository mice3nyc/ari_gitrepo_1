## AI 리터러시 v1.2-elem (초등) — 개발자 핸드오프

**작성일**: 2026-05-17 (세션365 v11 분기)
**대상**: 동현공 (코드리뷰 + 런칭 점검) / 정예공 (콘텐츠 작가) / 이다연 (초등 현장 검토)
**라이브 URL**: https://mice3nyc.github.io/ari_gitrepo_1/ai-literacy-delegation-boundary/v12-elem/
**리포**: https://github.com/mice3nyc/ari_gitrepo_1

> v1.1에서 분기. **이 빌드는 초등 고학년용 — 분기 직후 시점에는 v11 데이터 그대로(작업 진행하며 시나리오·역량 카드·튜토리얼·어투 정정 예정).** 중등용은 별도 `v12-mid` 빌드. 분기 사유: 이다연 선생님(초등 고학년 현장) 1차 피드백 — (1) 시나리오 소재가 초등이 AI 찾는 상황과 불일치(자기소개·독후감 등), (2) 위임 결로만 가지 말고 일부 시나리오는 AI 윤리 결로(심심한 대화·친구 관계·개인정보), (3) 역량 카드 수 축소 + 미리 보여주기, (4) 튜토리얼 이미지 동반, (5) 선택지 어투 재미있게, (6) 모범 플레이 시 시간 부족 → 오개념 우려. 덱스 시나리오 1차 초안 준비 중.
>
> 본 HANDOFF 본문은 v1.1 시점 그대로(데이터·SPEC 작업 진행 후 본문 갱신 예정).
