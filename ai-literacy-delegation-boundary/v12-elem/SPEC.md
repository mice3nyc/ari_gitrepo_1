...
**최종 업데이트**: 2026-05-17 세션365 (v1.1에서 분기, 중등용 v12-mid와 동시 신설)
**PLAN**: [[PLAN|PLAN.md]] / **TASKS**: [[TASKS|TASKS.md]] / **DESIGN**: [[DESIGN-REGISTRY|DESIGN-REGISTRY.md]]
**스타일 가이드 원본**: [[AI 리터러시 게임 — 스타일 가이드]]

> v1.1 SPEC을 계승. 기능/밸런스/데이터 구조/디자인은 v1.1 SPEC 참조.
> 이 빌드(v1.2-elem)는 초등 고학년용 — 분기 직후 v11 데이터 그대로. 시나리오·역량 카드·튜토리얼·어투 정정은 다음 회기부터 (이다연 선생님 피드백 + 덱스 시나리오 초안 반영).
> 본 SPEC 본문은 v1.1 시점 그대로 (데이터·메카닉 변경 시 갱신).
