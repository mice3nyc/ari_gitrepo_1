# DESIGN REGISTRY — v12-elem (v0.8 본문 계승)

> [!info] 이 문서는 v12-elem (초등) 빌드 안 — v0.8 디자인 본문 그대로
> 분기 직후 디자인 변경 없음. 초등 대상 튜토리얼 이미지·역량 카드 UI 변경은 데이터 정정 단계에서 디자인 결정 후 본 문서에 갱신. v12 분기 결정은 상위 `DECISIONS.md` 5/17 § 참조.
