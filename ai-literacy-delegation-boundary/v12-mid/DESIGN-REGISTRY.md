# DESIGN REGISTRY — v12-mid (v0.8 본문 계승)

> [!info] 이 문서는 v12-mid (중등) 빌드 안 — v0.8 디자인 본문 그대로
> 분기 직후 디자인 변경 없음. v12 분기 결정은 상위 `DECISIONS.md` 5/17 § 참조. 초등용 빌드(v12-elem)도 동일 본문 사본.
