...
> [!info] 이 문서는 v12-mid (중등) 빌드 안 — v1.1 사본
> 본문은 v1.0/v1.1 시점 그대로(데이터·메카닉 변경 없음, v11 데이터 계승). v12 분기 결정은 상위 `DECISIONS.md` 5/17 §, 작업 요청 노트 [[요청.26.0517.2107-AI리터러시초중등분기빌드]] 참조. 초등용 빌드는 별도 `v12-elem/`.
