# SPEC — AI 리터러시: 위임의 경계 (v12 시점)

**최종 업데이트**: 2026-05-17 (v12 분기 — 세션365)

> [!info] 본 SPEC 본문은 v0.3 시점 기록
> v06 ~ v11 빌드별 데이터 구조·메카닉·디자인 최종 명세는 각 `vXX/SPEC.md` 참조. 최근 흐름:
> - v10 SPEC: Neo-Brutalism 디자인 + 5시나리오 통합 명세
> - v11 SPEC: v10 계승 + 성장 리포트 PDF 저장(window.print) 명세
> - **v12-mid (2026-05-17): v11 SPEC 계승. 데이터·메카닉 변경 없음 (중등 유지).** 본문은 v11 시점 그대로
> - **v12-elem (2026-05-17): v11 SPEC 계승.** 시나리오·역량 카드·튜토리얼·어투 정정은 다음 회기 진입 후 v12-elem SPEC 본문 갱신 (이다연 5 이슈 + 덱스 시나리오 초안 반영)
>
> 결정 기록: DECISIONS.md (4/27 v0.3 결정 6개 + 5/17 v12 분기 결정)
> 회의록: [[26.0427 위임의경계 — 시나리오 패키지 회의 흐름]]
> 이다연 1차 피드백: [[26.0517 AI 리터러시 — 이다연 선생님 1차 피드백 정리]]

> [!warning] v0.3 방향 전환 (4/27 회의 — 역사 기록)
> v0.1/v0.2는 평면 6시나리오 + 판단축 3개 + 자원 3개 구조. v0.3 = 트리 76노드 × 5시나리오 + 두 역량 + 점수 5등급 구조로 전면 재설계. (이후 v06 ~ v11에서 자리잡음)
