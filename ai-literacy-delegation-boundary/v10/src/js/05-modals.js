...
function showLevelUpModal(prevLevel,newLevel){
  return new Promise(function(resolve){
    ...
    document.getElementById('lvup-meter-delta').textContent='자원토큰 +'+lvBonus+' 추가 지급';
