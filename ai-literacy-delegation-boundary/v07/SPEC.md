## SPEC — v0.7 점수 framework

**최종 업데이트**: 2026-05-04 세션287 (v0.7 분기 — §0~§6 결정 묶음 반영: 합산 모델 + 공식형 박스 + 카드 매칭 활성화 + 두 풀 통합 + 타이틀 정정 + csv 재구성)
...
**새 threshold (CONFIG.pointThresholds)**:
| 등급 | 점수 |
|------|------|
| S | 95+ |
| A | 90~94 |
| B | 80~89 |
| C | 70~79 |
| D | 60~69 (60 미만도 D로 통일, 별도 F 등급 없음) |
