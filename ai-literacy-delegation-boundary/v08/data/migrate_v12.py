#!/usr/bin/env python3
"""v12 CSV → scenarios.yaml 마이그레이션 (v11 위에 덮어쓰기)

v12 변경: CUT6 보정 피드백 등급별 5종 통일 (135건) + 리플레이 제안 갱신 (103건)
점수/등급/카드 등 나머지 필드는 v11과 동일하므로 전수 재적용.
"""
import csv
import sys
...
CSV_PATH = DATA_DIR / "03-ai-literacy-v12-final-integrated-data.csv"
YAML_PATH = DATA_DIR / "scenarios.yaml"
BACKUP_PATH = DATA_DIR / "scenarios.yaml.before-v12-migration"
