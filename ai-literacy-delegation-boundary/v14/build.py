...
VARIANT_CONFIG_REPLACEMENTS = {
    ...
    "elem": {
        "storageKey:'ai-literacy-delegation-boundary-v14-mid'":
            "storageKey:'ai-literacy-delegation-boundary-v14-elem'",
        "eventLogKey:'ai-literacy-delegation-boundary-v14-mid-events'":
            "eventLogKey:'ai-literacy-delegation-boundary-v14-elem-events'",
        "sessionIdKey:'ai-literacy-v14-mid-session-id'":
            "sessionIdKey:'ai-literacy-v14-elem-session-id'",
        "outboxKey:'ai-literacy-delegation-boundary-v14-mid-outbox'":
            "outboxKey:'ai-literacy-delegation-boundary-v14-elem-outbox'",
        "version:'v1.4-mid-r0'":
            "version:'v1.4-elem-r0'",
